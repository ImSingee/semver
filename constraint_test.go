...
func TestParseConstraint(t *testing.T) {
	tests := []struct {
		...
		{"1.0", constraintTilde, "1.0", false},
		{"foo", nil, "", true},
		{"<= 1.2", constraintLessThanEqual, "1.2", false},
		{"=< 1.2", constraintLessThanEqual, "1.2", false},
		{"=> 1.2", constraintGreaterThanEqual, "1.2", false},
		{"v1.2", constraintTilde, "1.2", false},
		{"=1.5", constraintEqual, "1.5", false},
...
func TestConstraintCheck(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run("constraint %"+tc.constraint+" with "+tc.version, func(t *testing.T) {
...
func TestNewConstraint(t *testing.T) {
	tests := []struct {
		...
		{"12.3.34~ 1.2.3", 1, 2, true}, // TODO maybe not error?
...
func TestConstraintsCheck(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run("constraint "+tc.constraint+" to "+tc.version, func(t *testing.T) {
...
func TestConstraintsValidate(t *testing.T) {
	...
	t.Run("multiple errors", func(t *testing.T) {
		...
		tt.AssertEqual(t, "1.2.3 does not have same major version as 2", msgs[0].Error())
		tt.AssertEqual(t, "1.1.x contains <= operator which is not supported for .x", msgs[1].Error())
	})
	...
	tests2 := []struct {
		...
		{"<1.x", "2.1.1", "1.x contains < operator which is not supported for .x"},
		{"<1.1.x", "1.2.1", "1.1.x contains < operator which is not supported for .x"},
		{">=1.1", "0.0.9", "0.0.9 is less than 1.1"},
		{"<=2.x", "3.1.0", "2.x contains <= operator which is not supported for .x"},
		{"<=1.1", "1.2.1", "1.2.1 is greater than 1.1"},
		{"<=1.1.x", "1.2.500", "1.1.x contains <= operator which is not supported for .x"},
		...
		{"^0.2", "0.3.0", "0.3.0 does not have same minor version as 0.2"},
		{"^0.2", "0.1.1", "0.1.1 does not have same minor version as 0.2"},
		{"^0.0.3", "0.1.1", "0.1.1 does not have same minor version as 0.0.3"},
		{"^0.0.3", "0.0.4", "0.0.4 does not have same 3 part version as 0.0.3"},
		{"^0.0.3", "0.0.2", "0.0.2 does not have same 3 part version as 0.0.3"},
